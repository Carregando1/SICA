...
class CurrentState:
    ...
    Args:
    initial: the IC of the 2-state SICA. Shape of 'initial' is (width, length), with all entries being integers
    between 0 and states-1.

    rules: The SRT of the 2-state SICA. Shape of 'rules' is (height-1, width, length, 18), where the
